...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.checkBox_autosaveEnable = QtWidgets.QCheckBox(self.groupBox_9)
        self.checkBox_autosaveEnable.setLayoutDirection(QtCore.Qt.RightToLeft)
        self.checkBox_autosaveEnable.setText("")
        self.checkBox_autosaveEnable.setChecked(True)
        self.checkBox_autosaveEnable.setObjectName("checkBox_autosaveEnable")
        self.horizontalLayout_17.addWidget(self.checkBox_autosaveEnable)
        ...
        self.spinBox_autosaveTimerInterval = QtWidgets.QSpinBox(self.groupBox_9)
        self.spinBox_autosaveTimerInterval.setSuffix("")
        self.spinBox_autosaveTimerInterval.setMinimum(1)
        self.spinBox_autosaveTimerInterval.setMaximum(6000)
        self.spinBox_autosaveTimerInterval.setSingleStep(10)
        self.spinBox_autosaveTimerInterval.setProperty("value", 10)
        self.spinBox_autosaveTimerInterval.setObjectName("spinBox_autosaveTimerInterval")
        self.horizontalLayout_16.addWidget(self.spinBox_autosaveTimerInterval)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.groupBox_9.setTitle(_translate("Dialog", "Autosave"))
        self.label_24.setText(_translate("Dialog", "Enable"))
        self.checkBox_autosaveEnable.setToolTip(_translate("Dialog", "Enables autosave. Highly recommended especially until the program becomes stable. Disable if you are handling large schematics and are seeing noticeable slowdown during interactions."))
        self.label_25.setText(_translate("Dialog", "Timer interval (sec)"))
        self.spinBox_autosaveTimerInterval.setToolTip(_translate("Dialog", "Sets the time interval between autosaves in seconds. Set to a low value if you\'re frequently experiencing crashes and to a high value if you\'re working with large schematics that take a long time to save."))
