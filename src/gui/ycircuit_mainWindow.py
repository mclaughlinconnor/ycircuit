...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.lineEdit_symbolPreviewFilter.setProperty("clearButtonEnabled", False)
        ...
        self.menuMinor_grid_point_spacing.setProperty("toolTipsVisible", True)
