...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.toolButton_symbolPreviewDirectory = QtWidgets.QToolButton(self.centralwidget)
        self.toolButton_symbolPreviewDirectory.setMinimumSize(QtCore.QSize(0, 24))
        self.toolButton_symbolPreviewDirectory.setPopupMode(QtWidgets.QToolButton.MenuButtonPopup)
        self.toolButton_symbolPreviewDirectory.setToolButtonStyle(QtCore.Qt.ToolButtonTextOnly)
        self.toolButton_symbolPreviewDirectory.setArrowType(QtCore.Qt.NoArrow)
        self.toolButton_symbolPreviewDirectory.setObjectName("toolButton_symbolPreviewDirectory")
        self.verticalLayout.addWidget(self.toolButton_symbolPreviewDirectory)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.toolButton_symbolPreviewDirectory.setToolTip(_translate("MainWindow", "Pick the folder to show symbol previews for. The folders in the drop-down menu can be customized through Options."))
        self.toolButton_symbolPreviewDirectory.setText(_translate("MainWindow", "Symbol directory"))
